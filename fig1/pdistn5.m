function [p05, p95, pmid, pmode] = pdistn5(q, s, muone, delk);
...
for ov = 1:size(q,2)
 ...
 dels=1e-5;% can be changed to 5 if there is too many 1's in a row. but it does make the program run much slower. 
